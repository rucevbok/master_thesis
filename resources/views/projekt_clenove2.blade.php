...
<div class="section">
<div class="box"> 
	<h3 class="title">Přehleed projektů</h3>
<table class="table">
	<thead>
		<tr>
...
@foreach($uz as $zaznam)
	...
	<tr>
		<td>
			<a  href="/detail_projektu/{{$zaznam->idproj}}" value= "{{$zaznam->idproj}}" > {{$zaznam->nazev}}</i></a>
		</td>
		<td>
			<p  href="/detail_projektu/{{$zaznam->idproj}}" value= "{{$zaznam->popis}}" > {{$zaznam->popis}}</i></p>
		</td>
		<td>
			<p  href="/detail_projektu/{{$zaznam->name}}" value= "{{$zaznam->name}}" > {{$zaznam->name}}</i></p>
		</td>
	</tr>
...
@endforeach
	...
	<div class="box"> 
		<h3 class="subtitle">Vytvořit nový</h3>
